...
ndvi_df = pd.read_csv('sorted_NDVI_data.csv')  # NDVI data with Latitude, Longitude, NDVI
elevation_df = pd.read_csv('sorted_India_Elevation.csv')  # Elevation data with Longitude, Latitude, Elevation
population_df = pd.read_csv('acc_india_population_data.csv')  # Population Density data with Longitude, Latitude, Population Density
